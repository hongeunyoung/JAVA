...
public class BankAccount {
	...
	public void deposit(int money) throws NegativeBalanceException {
		if(money < 0) {
			throw (new NegativeBalanceException("입금액으로 음수값이 입력되었습니다. 다시 입력하세요."));
		}
	...
	public void withdraw(int money) throws NegativeBalanceException {
		if(balance < money) {
			throw (new NegativeBalanceException("출금액이 잔고보다 많습니다. 다시 입력하세요."));
		}
		
		if(money < 0) {
			throw (new NegativeBalanceException("출금액으로 음수값이 입력되었습니다. 다시 입력하세요."));
		}
